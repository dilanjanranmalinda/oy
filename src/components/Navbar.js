...
export function NavbarDefault() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-red">
      <img
      
          src={image1} // Using the imported image here
          alt="Logo"
          color="black"
          className="h-10" // Adjust the size of the logo as needed
        />
        <Typography
          as="a"
          href="#"
